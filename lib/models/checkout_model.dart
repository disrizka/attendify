...
ChekoutResponse chekoutResponseFromJson(String str) =>
    ChekoutResponse.fromJson(json.decode(str));

String chekoutResponseToJson(ChekoutResponse data) =>
    json.encode(data.toJson());

class ChekoutResponse {
  final String? message;
  final Data? data;

  ChekoutResponse({this.message, this.data});

  factory ChekoutResponse.fromJson(Map<String, dynamic> json) =>
      ChekoutResponse(
